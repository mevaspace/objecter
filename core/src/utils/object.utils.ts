...
function markSeen(obj: object, seen: WeakSet<object>): void {
  if (seen.has(obj)) {
...
function cloneArray(src: unknown[], seen: WeakSet<object>): unknown[] {
...
function cloneCustomClass(src: Record<string, unknown>, seen: WeakSet<object>): Record<string, unknown> {
...
function clonePlainObject(src: Record<string, unknown>, seen: WeakSet<object>): Record<string, unknown> {
...
function cloneObject(src: Record<string, unknown>, seen: WeakSet<object>): Record<string, unknown> {
...
function cloneValue<T>(x: T, seen: WeakSet<object>): T {
